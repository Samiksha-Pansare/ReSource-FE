      ...
      <form action="#">
        <div className="user-details">
          <div className="input-box">
            ...
            <input type="text" placeholder="Lab Name" value={labd}  required/>
          </div>
          
          <div className="input-box">
            <span className="details">Start Time</span>
            <input type="time" placeholder="" value={start}  required/>
          </div>
          <div className="input-box">
            <span className="details">End Time</span>
            <input type="time" placeholder="" value={end} required/>
          </div>
        ...
        <button type='button' onClick="/addlab">Register</button>
